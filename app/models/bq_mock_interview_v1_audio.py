...
user_info_extract_agent = Agent(
    ...
    instructions=("You are a helpful assistant who can extract user information from text and" 
                  "generate high quality interview behavior questions based on the information you obtain.\n" 
                  ...
                  "3. generate 5 behavior questions based on the Job Description Summary and Resume Summary" 
                  "4.Do not provide answers to the questions. "
                  "5. Once the process is complete, transfer control back to the `bq_mock_interview_agent`, do not present questions"),
